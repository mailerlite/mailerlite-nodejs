...
import type { CampaignsInterface, GetParams, ListCampaignsResponse, SingleCampaignResponse, CreateUpdateParams, ScheduleParams } from './campaigns.types.js';
...
export default class Campaign implements CampaignsInterface {
     ...
     */
    public get(params: GetParams): Promise<AxiosResponse<ListCampaignsResponse>> {
